...
import { Search, Phone, MapPin, Plus, Users, BookOpen, GraduationCap, Baby, Pencil, Trash2 } from "lucide-react";
      ...
      setStudentList((prev) =>
        prev.map((s) =>
          s.id === editingStudent.id
            ? { ...s, name, address, class: selectedClass, birthDate: format(birthDate, "yyyy-MM-dd") }
            : s
        )
      );
